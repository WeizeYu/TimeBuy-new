...
-(void)drawRect:(CGRect)rect{
    ...
    */
    ...
    CGRect myrect = CGRectMake(rect.size.width - titleSize.width - 2, (height - 12) / 2, kThumbnailLength, CGFLOAT_MAX);
    ...
    [self.text drawInRect:myrect withAttributes:attributes];
